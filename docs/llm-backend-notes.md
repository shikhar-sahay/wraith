...
- **Wraith cloud (`us-east-1`):** Instance `wraith-us-east-static` recovered with EBS snapshot (see `docs/us-east-recovery.md`); telemetry `reports/us-east/` 12 IPs, 12 sessions, 21103 commands from `2026-07-12` to `2026-09-06`; observational comparison in `docs/deployment-comparison.md` (caveat: different regions/periods).
